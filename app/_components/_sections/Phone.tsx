...
const IPhone = () => {
  ...
  return (
    <>
      <div className="relative flex w-full items-center justify-center md:justify-start gap-8">
          ...
          <div className="absolute top-0 container p-6">
            <div className="flex justify-between">
              ...
              <div className="flex md:hidden">
                <div className="flex justify-center text-black text-md italic font-bold">
                  {text.split("").map((char, index) => (
                    <span
                      key={index}
                      className={
                        index % 2 === 0 ? "font-playfair" : "font-dmSans"
                      }
                    >
                      {char}
                    </span>
      ...
      <div className="md:hidden flex justify-center mt-4">
        {displayedItem && (
          <Image
            src={displayedItem.importPath}
            alt={`Clothes ${displayedItem.id}`}
            className="w-[250px] rounded-tl-2xl rounded-tr-2xl"
          />
        )}
      </div>
    </>
